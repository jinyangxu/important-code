...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        if test_acc > max_acc:
            ...
            torch.save(model, '/home/zsz2/pytorch-code/xjy/save/fold/usm/usm.pth')
...
plt.xlabel('EPOCH')
plt.legend()
plt.savefig('/home/zsz2/pytorch-code/xjy/save/fold/usm/usm_acc.png')
...
plt.xlabel('EPOCH')
plt.legend()
plt.savefig('/home/zsz2/pytorch-code/xjy/save/fold/usm/usm_loss.jpg')
