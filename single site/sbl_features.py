...
加载GPU上预训练好的模型
'''
reloadmodel = torch.load('/home/zsz2/pytorch-code/xjy/save/fold/sbl/sbl.pth').to(device)
...
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sbl/sbl_train_features.npy', train_features)
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sbl/sbl_train_labels.npy', train_labels)
...
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sbl/sbl_test_features.npy', test_features)
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sbl/sbl_test_labels.npy', test_labels)
