...
加载GPU上预训练好的模型
'''
reloadmodel = torch.load('/home/zsz2/pytorch-code/xjy/save/fold/sdsu/sdsu.pth').to(device)
...
train = ImageFolder('/data/zsz2/fold/glass_data1/sdsu/train', train_transform)
train_num = len(train)
...
test = ImageFolder('/data/zsz2/fold/glass_data1/sdsu/test', test_transform)
test_num = len(test)
...
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sdsu/sdsu_train_features.npy', train_features)
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sdsu/sdsu_train_labels.npy', train_labels)
...
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sdsu/sdsu_test_features.npy', test_features)
np.save('/home/zsz2/pytorch-code/xjy/save/fold/sdsu/sdsu_test_labels.npy', test_labels)
