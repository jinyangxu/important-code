...
class LeNet5(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(400, 120) # 这里论文上写的是conv,官方教程用了线性层
...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        if test_acc > max_acc:
           ...
           torch.save(model, '/home/zsz2/pytorch-code/xjy/save/fold/caltech/caltech.pth')
'''
绘制训练曲线
'''
...
plt.xlabel('EPOCH')
plt.legend()
plt.savefig('/home/zsz2/pytorch-code/xjy/save/fold/caltech/caltech_acc.png')
...
plt.xlabel('EPOCH')
plt.legend()
plt.savefig('/home/zsz2/pytorch-code/xjy/save/fold/caltech/caltech_loss.png')

#torch.save(model, '/home/zsz2/pytorch-code/xjy/save/um1.pth')
