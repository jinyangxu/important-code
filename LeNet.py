...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        if test_acc > max_acc:
            ...
            torch.save(model.state_dict(), '/home/zsz2/pytorch-code/xjy/save/ceshi.pth')
...
plt.xlabel('EPOCH')
plt.legend()
plt.savefig('/home/zsz2/pytorch-code/xjy/save/ceshi_acc.png')
...
plt.xlabel('EPOCH')
plt.legend()
plt.savefig('/home/zsz2/pytorch-code/xjy/save/ceshi_loss.jpg')
